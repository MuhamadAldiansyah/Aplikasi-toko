     ...
     <div class="col-12 col-md-6 mt">
        <form action="" method="post">
            ...
            <div class="mt-5 d-flex justify-content-between">
                <button type="submit" class="btn btn-primary" style="width: 200px; height: 50px;" name="editBtn">Edit</button>
                <button type="submit" class="btn btn-danger" style="width: 200px; height: 50px;" name="deleteBtn">Delete</button>
            </div>
        </form>
