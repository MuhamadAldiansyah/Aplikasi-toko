...
<body>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="kategori-detail.php?p=<?php echo $data['id']; ?>"
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center">
      ...
      <span class="mb-3 mb-md-0 text-muted">&copy; 2023 Muhamad Aldiansyah</span>
    </div>

    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      <li class="ms-3"><a href="index.php" class="text-muted"><i class="fas fa-home"></i></a></li>
      <li class="ms-3"></svg></a></li>
      <li class="ms-3"></svg></a></li>
    </ul>
  </footer>
</div>
